            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <div x-data="{ show: false }" class="relative flex items-center">
                        ...
                        <button type="button" @click="show = !show" class="absolute right-3 text-slate-400 hover:text-blue-500 focus:outline-none flex items-center justify-center h-full">
